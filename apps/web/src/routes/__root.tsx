...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PerkHub — Verified discounts for Nigeria's tribes" },
      {
        name: "description",
        content:
          "PerkHub verifies your affiliation — NYSC corps, alumni, professional bodies, cooperatives, staff associations — and unlocks exclusive discounts from Nigerian and global brands.",
      },
      { name: "author", content: "PerkHub" },
